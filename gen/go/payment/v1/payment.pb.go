...
const (
	PaymentStatus_PAYMENT_STATUS_UNSPECIFIED PaymentStatus = 0 // proto3 requires a zero value
...
type ProcessPaymentRequest struct {
	...
	Amount  int64  `protobuf:"varint,2,opt,name=amount,proto3" json:"amount,omitempty"` // cents — matches your int64 discipline
}
...
// reuses ProcessPaymentResponse as the item type to avoid
// introducing a second, near-identical message. If you later refactor
// to a shared `Payment` message, both RPCs can adopt it together.
...
var file_payment_v1_payment_proto_rawDesc = []byte{
	...
	0x54, 0x55, 0x53, 0x5f, 0x44, 0x45, 0x43, 0x4c, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x02, 0x32, 0x69,
	...
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x67, 0x69, 0x69, 0x61, 0x77, 0x2f, 0x61,
	0x70, 0x32, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x65, 0x6e,
